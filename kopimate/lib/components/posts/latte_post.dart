...
class LattePost extends StatefulWidget {
  final String msg;
  final String user;
  final String postId;
  ...
  @override
  State<LattePost> createState() => _LattePostState();
}

class _LattePostState extends State<LattePost> {
  ...
  void toggleLike() {
    ...
    DocumentReference postRef =
      FirebaseFirestore.instance.collection('Latte Posts').doc(widget.postId);
