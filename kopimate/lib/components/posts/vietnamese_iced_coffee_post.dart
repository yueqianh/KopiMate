...
class VietnameseIceCoffeePost extends StatefulWidget {
  final String msg;
  final String user;
  final String postId;
  ...
  @override
  State<VietnameseIceCoffeePost> createState() => _VietnameseIceCoffeePostState();
}

class _VietnameseIceCoffeePostState extends State<VietnameseIceCoffeePost> {
  ...
  void toggleLike() {
    ...
    DocumentReference postRef =
      FirebaseFirestore.instance.collection('Vietnamese Ice Coffee Posts').doc(widget.postId);
