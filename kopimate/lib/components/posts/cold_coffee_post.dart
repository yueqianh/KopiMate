...
class ColdCoffeePost extends StatefulWidget {
  final String msg;
  final String user;
  final String postId;
  ...
  @override
  State<ColdCoffeePost> createState() => _ColdCoffeePostState();
}

class _ColdCoffeePostState extends State<ColdCoffeePost> {
  ...
  void toggleLike() {
    ...
    DocumentReference postRef =
      FirebaseFirestore.instance.collection('Cold Coffee Posts').doc(widget.postId);
