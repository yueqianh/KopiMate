...
class EspressoPost extends StatefulWidget {
  final String msg;
  final String user;
  final String postId;
  ...
  @override
  State<EspressoPost> createState() => _EspressoPostState();
}

class _EspressoPostState extends State<EspressoPost> {
  ...
  void toggleLike() {
    ...
    DocumentReference postRef =
      FirebaseFirestore.instance.collection('Espresso Posts').doc(widget.postId);
